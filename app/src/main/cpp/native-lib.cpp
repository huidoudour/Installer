...
Java_io_github_huidoudour_Installer_util_NativeHelper_getNativeVersion(
        JNIEnv* env,
        jobject /* this */) {
 ...
 */
extern "C" JNIEXPORT jstring JNICALL
Java_io_github_huidoudour_Installer_util_NativeHelper_getCPUArchitecture(
        JNIEnv* env,
        jobject /* this */) {
 ...
 */
extern "C" JNIEXPORT jstring JNICALL
Java_io_github_huidoudour_Installer_util_NativeHelper_calculateSimpleHash(
        JNIEnv* env,
        jobject /* this */,
        jstring input) {
...
Java_io_github_huidoudour_Installer_util_NativeHelper_performanceTest(
        JNIEnv* env,
        jobject /* this */,
        jint iterations) {
...
Java_io_github_huidoudour_Installer_util_NativeHelper_isNativeLibraryLoaded(
        JNIEnv* env,
        jobject /* this */) {
    (void)env; //  intentionally unused parameter
 ...
 */
extern "C" JNIEXPORT jstring JNICALL
Java_io_github_huidoudour_Installer_util_NativeHelper_getBuildInfo(
        JNIEnv* env,
        jobject /* this */) {
